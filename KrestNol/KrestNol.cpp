...
// KrestNol.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKrestNolApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKrestNolApp

CKrestNolApp::CKrestNolApp()
{
...
// Единственный объект CKrestNolApp

CKrestNolApp theApp;


// Инициализация CKrestNolApp

BOOL CKrestNolApp::InitInstance()
{
